...
class SftpClass:
    def __init__(self, sftp_user: str, sftp_password: str, ip_address):
        ...
        logging.info("In the end of __init__ ")
    ...
    def connection(self):
        ...
        try:
            ...
            logging.error(f"Exception in create_sftp_connection() while creating a connection ::: {str(err)}")

    @staticmethod
    def upload_files(conn, local_path, remote_path):
        """
        Uploading the file.
        ...
        try:
            if conn is not None:
                ...
                logging.info(f"File has been uploaded...")
                return True, None
            ...
            logging.error(f"Exception in upload_files() ::: {str(err)}")
