...
END"""
    ...
    def main(self, args_val):
        ...
        try:
            ...
            self._logger.info('DATABASE_LOCK_ERRORS: ')
            ...
            count, error = self.update_command(sdp, cmd)
            count = str(count).strip() if count else None
            self._logger.info('DATABASE_LOCK_TIMEOUTS: ')
            ...
            if filename is not None:
                ...
                self._logger.info(f'ERROR:   DIAMETER_REJECT_FAIL: No file found')
                self._logger.info(f'ERROR:   DIAMETER_TRAFFIC: No file found')
                self._logger.info(f'ERROR:   DIRECTDEBIT_REJECT_FAIL: No file found')
                self._logger.info(f'ERROR:   DIRECT_DEBIT_TRAFFIC: No file found')
            ...
            if voice_filename is not None:
                ...
                self._logger.info(f'VOICE_FI_FR_REJECT_FAIL: No File Found')
                self._logger.info(f'VOICE_TRAFFIC_FI: No File Found')
                self._logger.info(f'VOICE_TRAFFIC_FR: No File Found')
